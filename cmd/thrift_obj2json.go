...
func init() {
	pyObj2jsonCmd.PersistentFlags().String("file", "./tmp/python_obj.log", "file contains python object string log")
	pyObj2jsonCmd.PersistentFlags().String("omit_null", "0", "if omit null field, default 0,set 1 to omit")
